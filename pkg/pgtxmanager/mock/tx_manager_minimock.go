...
//go:generate minimock -i github.com/pillarion/practice-platform/pkg/pgtxmanager.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mock
...
import (
	...
	mm_pgtxmanager "github.com/pillarion/practice-platform/pkg/pgtxmanager"
)

// TxManagerMock implements pgtxmanager.TxManager
type TxManagerMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcReadCommitted          func(ctx context.Context, f mm_pgtxmanager.Handler) (err error)
	inspectFuncReadCommitted   func(ctx context.Context, f mm_pgtxmanager.Handler)
	afterReadCommittedCounter  uint64
	beforeReadCommittedCounter uint64
	ReadCommittedMock          mTxManagerMockReadCommitted
}

// NewTxManagerMock returns a mock for pgtxmanager.TxManager
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Expect(ctx context.Context, f mm_pgtxmanager.Handler) *mTxManagerMockReadCommitted {
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Inspect(f func(ctx context.Context, f mm_pgtxmanager.Handler)) *mTxManagerMockReadCommitted {
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Set(f func(ctx context.Context, f mm_pgtxmanager.Handler) (err error)) *TxManagerMock {
	if mmReadCommitted.defaultExpectation != nil {
...
// Then helper
func (mmReadCommitted *mTxManagerMockReadCommitted) When(ctx context.Context, f mm_pgtxmanager.Handler) *TxManagerMockReadCommittedExpectation {
	if mmReadCommitted.mock.funcReadCommitted != nil {
		mmReadCommitted.mock.t.Fatalf("TxManagerMock.ReadCommitted mock is already set by Set")
	}
...
// ReadCommitted implements pgtxmanager.TxManager
func (mmReadCommitted *TxManagerMock) ReadCommitted(ctx context.Context, f mm_pgtxmanager.Handler) (err error) {
